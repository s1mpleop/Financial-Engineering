# -*- coding: utf-8 -*-
"""180123048_subhamkumar.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1fHUxG6G-c3W6ric-e9SEy1_X02KxskIL
"""
...
n_days = 20
print('Historical Volatility for BSE\n')
for company, prices in bse_data.items():
  vol = historicalVolatility(prices, n_days)
  print(" %s  = %.6f"%(company, vol))


print('\nHistorical Volatility for NSE\n')
...
for company, prices in bse_data.items():
    ...
    plt.title(f"Call Price vs Number of Months for {company} (BSE)")
    plt.legend(loc = 'upper right')
    plt.grid()
    plt.show()
for company, prices in nse_data.items():
    ...
    plt.xlabel("Number of Months")
    plt.ylabel("Call Price")
    plt.title(f"Call Price vs Number of Months for {company} (NSE)")
    plt.legend(loc = 'upper right')
    plt.grid()
    plt.show()
for company, prices in bse_data.items():
    ...
    plt.title(f"Put Price vs Number of Months for {company} (BSE)")
    plt.legend(loc = 'upper right')
    plt.grid()
    plt.show()
for company, prices in nse_data.items():
    ...
    plt.xlabel("Number of Months")
    plt.ylabel("Put Price")
    plt.title(f"Put Price vs Number of Months for {company} (NSE)")
    plt.legend(loc = 'upper right')
    plt.grid()
    plt.show()